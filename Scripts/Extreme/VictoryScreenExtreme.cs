...
public class VictoryScreenExtreme : MonoBehaviour
{
    private TextMeshProUGUI victoryText;
    private SceneControllerExtreme controller;

    // Start is called before the first frame update
    void Start()
    {
        this.controller = GameObject.Find("Scene Manager").GetComponent<SceneControllerExtreme>();
