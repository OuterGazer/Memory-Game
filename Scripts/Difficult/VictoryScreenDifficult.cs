...
public class VictoryScreenDifficult : MonoBehaviour
{
    private TextMeshProUGUI victoryText;
    private SceneControllerDifficult controller;

    // Start is called before the first frame update
    void Start()
    {
        this.controller = GameObject.Find("Scene Manager").GetComponent<SceneControllerDifficult>();
