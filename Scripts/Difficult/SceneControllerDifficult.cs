...
public class SceneControllerDifficult : MonoBehaviour
{
    ...
    [SerializeField] private MemoryCardDifficult originalCard;
    ...
    private MemoryCardDifficult firstCardRevealed;
    private MemoryCardDifficult secondCardRevealed;
    ...
    public void CardRevealed(MemoryCardDifficult inCard)
    {
    ...
    private IEnumerator CardFlipAnimation(MemoryCardDifficult inCard)
    { 
    ...
    void Start()
    {
        ...
        for (int i = 0; i < GRID_COLS; i++)
        {
            ...
            {
                MemoryCardDifficult currentCard;
                ...
                {
                    currentCard = GameObject.Instantiate<MemoryCardDifficult>(this.originalCard);
                }
