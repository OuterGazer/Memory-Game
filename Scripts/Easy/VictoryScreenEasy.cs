...
public class VictoryScreenEasy : MonoBehaviour
{
    private TextMeshProUGUI victoryText;
    private SceneControllerEasy controller;

    // Start is called before the first frame update
    void Start()
    {
        this.controller = GameObject.Find("Scene Manager").GetComponent<SceneControllerEasy>();
