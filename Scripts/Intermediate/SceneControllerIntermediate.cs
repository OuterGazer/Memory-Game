...
public class SceneControllerIntermediate : MonoBehaviour
{
    ...
    [SerializeField] private MemoryCardIntermediate originalCard;
    [SerializeField] private Sprite[] cardImages;

    [SerializeField] private AudioClip cardFlipSound;
    private AudioSource audioSource;

    private MemoryCardIntermediate firstCardRevealed;
    private MemoryCardIntermediate secondCardRevealed;
    ...
    public void CardRevealed(MemoryCardIntermediate inCard)
    {
    ...
    private IEnumerator CardFlipAnimation(MemoryCardIntermediate inCard)
    { 
    ...
    void Start()
    {
        ...
        for (int i = 0; i < GRID_COLS; i++)
        {
            ...
            {
                MemoryCardIntermediate currentCard;
                ...
                {
                    currentCard = GameObject.Instantiate<MemoryCardIntermediate>(this.originalCard);
                }
