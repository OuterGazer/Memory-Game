...
public class VictoryScreenIntermediate : MonoBehaviour
{
    private TextMeshProUGUI victoryText;
    private SceneControllerIntermediate controller;

    // Start is called before the first frame update
    void Start()
    {
        this.controller = GameObject.Find("Scene Manager").GetComponent<SceneControllerIntermediate>();
